...
class Embeddings(nn.Module):
    ...
    def __init__(self, vocab_size, hidden_size, max_position_size, dropout_rate):
        ...
        self.word_embeddings = nn.Embedding(vocab_size, hidden_size).to(device)
    ...
    def forward(self, input_ids):
        seq_length = input_ids.size(0)#本来是size(1)
        ...
        """
        #position_ids = position_ids.unsqueeze(0).expand_as(input_ids)之前有
        
        words_embeddings = self.word_embeddings(input_ids).to(device)
